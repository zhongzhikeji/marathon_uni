        ...
        <view class='list borRadius14'>
          <view class='item acea-row row-between-wrapper relative' @click="show =true">
            ...
            <view class="address flex alcenter">
              <view>
                <input disabled type='text' placeholder='请选择' placeholder-style="color:#ccc;" name='idType'
                  :value="datasub.idType" placeholder-class='placeholder' />
              </view>
          ...
          <view class='item acea-row row-between-wrapper relative' style="border-bottom: 1rpx solid #eee;"
            ...
            <view class="address flex alcenter">
              <input name='nationality' disabled="" type='text' placeholder='请选择' placeholder-style="color:#ccc;"
                :value="datasub.nationality" placeholder-class='placeholder' />
          ...
          <view class='item acea-row row-between-wrapper' style="border: none;">
            ...
            <input type='text' placeholder='请输入姓名' placeholder-style="color:#ccc;" name='name' :value="datasub.name"
              placeholder-class='placeholder' maxlength="5" />
          </view>
          <view class='item acea-row row-between-wrapper'>
            <view class='name'>年龄</view>
            <input type='number' placeholder='请输入联系电话' placeholder-style="color:#ccc;" name="age" :value='datasub.age'
              placeholder-class='placeholder' maxlength="2" />
          </view>
          <view class='item acea-row row-between-wrapper'>
          ...
          <view class='item acea-row row-between-wrapper'>
            ...
            <input type='text' placeholder='请输入邮箱' placeholder-style="color:#ccc;" name="email" :value='datasub.email'
          ...
          <view class='item acea-row row-between-wrapper relative' style="border-bottom: 1rpx solid #eee;"
            ...
            <view class="address flex alcenter">
              <input disabled="" type='text' placeholder='请选择' placeholder-style="color:#ccc;" name='birthday'
                :value="datasub.birthday" placeholder-class='placeholder' />
          ...
          <view class='item acea-row row-between-wrapper relative' style="border-bottom: 1rpx solid #eee;"
            ...
            <view class="address flex alcenter">
              <input disabled="" type='text' placeholder='请选择' name='clothingSize' placeholder-style="color:#ccc;"
                :value="datasub.clothingSize" placeholder-class='placeholder' />
          ...
          <view class='item acea-row row-between-wrapper relative' style="border-bottom: 1rpx solid #eee;"
            ...
            <view class="address flex alcenter">
              <input disabled="" type='text' placeholder='请选择' placeholder-style="color:#ccc;" name='bloodType'
                :value="datasub.bloodType" placeholder-class='placeholder' />
          ...
          <view class='item acea-row row-between-wrapper'>
            ...
            <input type='text' placeholder='请输入紧急联系人' placeholder-style="color:#ccc;" name="emergencyContactName"
              :value='datasub.emergencyContactName' placeholder-class='placeholder' maxlength="11" style="flex:1" />
          </view>
          <view class='item acea-row row-between-wrapper'>
            <view class='name'>紧急联系人电话</view>
            <input type='number' placeholder='请输入紧急联系电话' placeholder-style="color:#ccc;" name="emergencyContactPhone"
              :value='datasub.emergencyContactPhone' placeholder-class='placeholder' maxlength="11" style="flex:1;" />
          </view>
        </view>
        ...
        <view>
          ...
          <view class='list borRadius14'>
            <view v-for="(item,index) in datasub.extraInfos">
              <!-- 图片上传类型 -->
              <view v-if="item.fieldType == 'image'" class="pt10 pb10">
              ...
              <!-- 其他输入字符串类型 -->
              <!-- <view class='item acea-row row-between-wrapper' v-else-if="item.fieldType == 'string'"> -->
              <view class='item acea-row row-between-wrapper' v-else>
                <view class='name'>{{item.fieldName}}</view>

                <input type='text' placeholder-style="color:#ccc;" v-model="item.value"
                  placeholder-class='placeholder' />
              </view>
      ...
      uploadFilePromise(url, pathName) {
        return new Promise((resolve, reject) => {
          let a = uni.uploadFile({
            url: 'https://api.runplus.zznet.live/app-api/infra/file/upload', // 仅为示例，非真实的接口地址
            filePath: url,
            name: 'file',
            formData: {
              path: pathName
        ...
        if (this.datasub.extraInfos) {
          this.datasub.extraInfos.forEach(item => {
            if (item.fieldType == 'image') {
              ...
              item.value = this.fileList1.map(item=>item.url).join(',')
            }
          })
        }
