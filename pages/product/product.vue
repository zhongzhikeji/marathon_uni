		...
		<view>
			<scroll-view :scroll-top="scrollTop" scroll-y='true' scroll-with-animation="true"
                ...
                <!-- 市场价 -->
						...
						<!-- SKU 选择 -->
						<view class='attribute acea-row row-between-wrapper mb5 borRadius14' @click="openAttr">
							<view class="line1">{{ attrValue.length > 0 ? "已选择" : "商品规格" }}：
						...
						<!-- 优惠劵 -->
						<!--  -->
						<view class='attribute acea-row row-between-wrapper mb5 borRadius14'
						...
						<view class='attribute acea-row row-between-wrapper mb5 borRadius14' @click="">
							<view class="line1"> 服务：
								<text class='atterTxt'>满99包邮 正品</text>
							</view>
							<view class='iconfont icon-jiantou'></view>
						</view>
						<!-- 评论 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 		query.exec((res) => {
			// 		  console.log(res)
			// 			 if(JSON.stringify(res[0] != JSON.stringify([null]))){
			// 				 const top = res[0].top;
